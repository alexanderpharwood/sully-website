...
Sully.registerView('docs-server-config', '{{view:header}}<div class="page-content">    <div id="view-docs-server-config" class="container">        <div class="row">            <div class="col-sm">                <h1>Documentation</h1>                <hr>            </div>        </div>        <div class="row">            {{view:docs-sidebar}}            <div class="col-sm-9">                <h3>Server configurtion</h3>                <p>There are some slight server-side tweaks needed for the router to work properly. The idea is simple: to point all requests, except for                scripts and images, etc., to your index.html, where the Sully router will take over. You may also wish for Sully to handle errors like 404 and 403,                so you should specify these endpoints in your router.</p>                <p>Here are some basic, example server configuration files to get you going:                <p><b>Apache (.htaccess)</b></p><pre class="prettyprint lang-bash">RewriteEngine On<br><br># Uncomment to force https in production<br># RewriteCond %{HTTPS} off<br># RewriteRule ^(.*)$ https://%{HTTP_HOST}%{REQUEST_URI} [L,R]<br><br># If an existing asset or directory is requested go to it as it is<br>RewriteCond %{DOCUMENT_ROOT}%{REQUEST_URI} -f [OR]<br>RewriteCond %{DOCUMENT_ROOT}%{REQUEST_URI} -d<br>RewriteRule ^ - [L]<br><br># If the requested resource doesn&apos;t exist, use index.html<br>RewriteRule ^ index.html<br><br># Error handling<br># If your app is not at the root of your server,<br># you will need to add the base prefix here, e.g:<br># ErrorDocument 404 /directory/subdirectory/403<br>ErrorDocument 403 /403<br>ErrorDocument 404 /404<br><br># Do not show directory contents.<br>Options -Indexes</pre><br>                <p><b>Nginx</b></p><pre class="prettyprint lang-nginx">server {<br>    server_name Sully;<br><br>    index index.html;<br><br>    #This should match your base defined in index.html<br>    root /path/to/app;<br><br>    location / {<br>        try_files $uri $uri/ /index.html;<br>    }<br>}</pre><br>                <p><b>Node - Express</b></p><pre class="prettyprint lang-javascript">const express = require("express");<br>var app = express();<br><br>//Ignore requests with "/app/" in the url (for static content).<br>app.get(&apos;*/app/*&apos;, express.static(__dirname));<br><br>app.all(&apos;/*&apos;, function(req, res, next) {<br>    res.sendFile(&apos;index.html&apos;, { root: __dirname });<br>});<br><br>app.listen(3000);</pre><br>                <p>The team at angular-ui have written a great FAQ article on this topic. <a href="https://github.com/angular-ui/ui-router/wiki/Frequently-Asked-Questions#how-to-configure-your-server-to-work-with-html5mode" class="no-route-catch" target="_blank">Check it out.</a></p>            </div>        </div>    </div></div>');

Sully.registerView('docs-build-json', '{{view:header}}<div class="page-content">    <div id="view-docs-init" class="container">        <div class="row">            <div class="col-sm">                <h1>Documentation</h1>                <hr>            </div>        </div>        <div class="row">            {{view:docs-sidebar}}            <div class="col-sm-9">                <h3>The build.json file</h3>                <p>Every project contains a buid.json file. It&apos;s what tells the Sully compiler how to build the project.                 Here is an example:</p><pre class="prettyprint">{<br>    "build": {<br>        "output": "app/build/app.js",<br>        "scripts": [<br>            "scripts/entry.js"<br>        ],<br>        "router": "router.js",<br>        "controllers": {<br>            "index": "controllers/IndexController.js",<br>            "error": "controllers/ErrorController.js"<br>        },<br>        "views": {<br>            "header": "views/common/header.html",<br>            "404": "views/404.html",<br>            "403": "views/403.html",<br>            "index": "views/index.html",<br>            "test": "views/test.html"<br>        },<br>        "middleware": {<br>            "example": "middleware/ExampleMiddleware.js"<br>        }<br>    },<br>    "serve": {<br>        "staticPaths": [<br>            "app"<br>        ],<br>        "port": 3000<br>    },<br>    "autobuilder": {<br>        "path": "",<br>        "ignore": [<br>            "app/build"<br>        ]<br>    },<br>    "release": {<br>        "version": "1.0.0",<br>        "include": [<br>            "index.html",<br>            "app"<br>        ]<br>    }<br>}<br></pre>            <p>Here is a brakedown of each part:</p>            <p><b>build.output</b></p>            <p>The output location for your build JavaScript file. A compressed version will also be generated, with the suffix of ".min.js".</p>            <p><b>build.controllers</b></p>            <p>A list of alll your controllers, keyed by name, with a                value of the location of the controller.</p>            <p><b>build.views</b></p>            <p>A list of alll your views, keyed by name, with a                value of the location of the view.</p>            <p><b>build.middleware</b></p>            <p>A list of alll your middleware, keyed by name, with a                value of the location of the middleware.</p>            <p><b>serve.staticPaths</b></p>            <p>A list of all files or directories the "serve" command should treat as static content            and not redirect to index.html. This would be used for css files, JavaScript files, and images for example.</p>            <p><b>serve.port</b></p>            <p>The port for the the "serve" command to use. This can also be set via the <a href="/docs/cli">command line</a>.                If no port is specified, Sully will use 3000.</p>            <p><b>autobuilder.path</b></p>            <p>The file or directory for the autobuilder to watch and perform builds when files change. This can also be set via the <a href="/docs/cli">command line</a>.            If none is specified, Sully will listen for changes in all files.</p>            <p><b>autobuilder.ignore</b></p>            <p>A list of files and/or directories to ignore on change. You should ensure that your build output location is in this list            to avoid the autobuilder looping.</p>            <p><b>release.version</b></p>            <p>The version of the release to build.</p>            <p><b>release.include</b></p>            <p>An array of files and/or directories to include in the release.</p>            </div>            </div>        </div>    </div></div>');
...
window.onload = function(){
    ...
    Sully.init({
        container: "Sully",
        exceptionMessage: " ¯\\_(ツ)_/¯<br>Oops, we've had a spillage!",
    });
