...
Sully.registerView('releases', '{{view:header}}<div class="page-content">    <div id="view-docs" class="container">        <div class="row">            <div class="col-sm">                <ul class="docs-sidebar">                    <h3>latest stable (v1.0.1)</h3>                    <li>                        <a href="releases/1.0.1/sully-1.0.1.js" class="no-route-catch">Development, uncompressed</a>                    </li>                    <li>                        <a href="releases/1.0.1/sully-1.0.1.min.js" class="no-route-catch">Production, compressed</a>                    </li>                </ul>            </div>        </div>    </div></div>');
...
Sully.registerView('docs-request', '{{view:header}}<div class="page-content">    <div id="view-docs-request" class="container">        <div class="row">            <div class="col-sm">                <h1>Documentation</h1>                <hr>            </div>        </div>        <div class="row">            {{view:docs-sidebar}}            <div class="col-sm">                <h3>The request object</h3>                <p>The request object is passed into your controller. Through it, you can access                    things like query data, url parameters, etc.</p>                <p>For example, take the below route:</p><pre class="prettyprint">Sully.registerRoute({<br>    name: &apos;book&apos;,<br>    route: &apos;/book/{id}&apos;,<br>    controller: &apos;book&apos;,<br>    method: &apos;show&apos;,<br>});<br></pre>                <p>With a url of https://example.com/book/31, your request object will look like this:</p><pre class="prettyprint">{ id : "31" }</pre>            </div>        </div>    </div></div>');

Sully.registerView('docs-init', '{{view:header}}<div class="page-content">    <div id="view-docs-init" class="container">        <div class="row">            <div class="col-sm">                <h1>Documentation</h1>                <hr>            </div>        </div>        <div class="row">            {{view:docs-sidebar}}            <div class="col-sm">                <h3>The init method</h3>                <p>To initialise Sully, you need to call Sully.init() with the approprtiate parameters.</p><pre class="prettyprint">Sully.init({<br>    container: "Sully",<br>    exceptionMessage: "Something went wrong there...",<br>});</pre>            <p>The container is the id of your main sully div. The exception message is what will be shown                to the user when something goes wrong. This will only be shown if a fatal error occurs.</p>            </div>        </div>    </div></div>');
